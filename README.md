...
```powershell
.\vcpkg install qt5-base:x64-windows sqlite3:x64-windows curl:x64-windows nlohmann-json:x64-windows glog:x64-windows jsoncpp:x64-windows rapidjson:x64-windows cpp-httplib:x64-windows openssl:x64-windows libwebsockets:x64-windows gtest:x64-windows
```
